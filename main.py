...
def main():
    ...
    train_parser.add_argument('--game', default='chinese_chess', help='游戏名称')
    train_parser.add_argument('--algorithm', default='muzero', choices=['muzero', 'alphazero'], help='算法')
    train_parser.add_argument('--device', default='cuda', help='设备')
    train_parser.add_argument('--channels', type=int, default=128, help='网络通道数')
    train_parser.add_argument('--blocks', type=int, default=6, help='网络块数')
    train_parser.add_argument('--simulations', type=int, default=200, help='MCTS 模拟次数')
    train_parser.add_argument('--batch-size', type=int, default=512, help='批大小')
    ...
    train_parser.add_argument('--games-per-epoch', type=int, default=100, help='每轮自玩局数')
    train_parser.add_argument('--num-envs', type=int, default=64, help='并行环境数')
    train_parser.add_argument('--log-dir', default='./logs', help='日志目录')
    train_parser.add_argument('--log-backends', default='console,tensorboard', help='日志后端')
    ...
    eval_parser.add_argument('--device', default='cuda', help='设备')
