...
class Board(BaseBoard):
    ...
    def _set_piece_bb(self, piece_type, bb):
        if piece_type == PAWN: self.pawns = bb
        elif piece_type == ROOK: self.rooks = bb
        elif piece_type == KNIGHT: self.knights = bb
        elif piece_type == BISHOP: self.bishops = bb
        elif piece_type == ADVISOR: self.advisors = bb
        elif piece_type == KING: self.kings = bb
        else: self.cannons = bb
